...
const infoCards = [
  {
    ...
    title: "Day Plan",
    description: "Marina at 1 PM, cruise at 2 PM, evening from 6:30 PM.",
    href: "#day-plan",
  },
  {
    icon: "hotels" as const,
    title: "Hotels",
    description: "Stays near Purobeach, Hilton & Port Olímpic.",
    href: "/venue#stay-nearby",
  },
  {
    icon: "directions" as const,
    title: "Directions",
    description: "Purobeach · Hilton for dinner · Port Olímpic for the cruise.",
    href: "/venue",
  },
  {
    icon: "weather" as const,
    title: "Dress Code",
    description: "Elegant for the evening celebration.",
    href: "#reservation",
  },
  {
    icon: "things" as const,
    title: "Free Time",
    description: "3:00–6:30 PM to rest, explore, or freshen up.",
    href: "#day-plan",
  },
  {
